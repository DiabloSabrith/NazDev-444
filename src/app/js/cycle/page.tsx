            ...
            <div className={styles.wrapper}>
                <div className={styles.wrapperOne_Item}>
                    ...
                    <div className={styles.first}>
                        ...
                        <p className={styles.data_p}>Значение в JavaScript всегда относится к данным определённого типа. Например, это может быть строка или число.
                ...
                <div className={styles.wrapperTwo_Item}>
                    <h1 className={styles.data_h1}>Java Script. Циклы</h1>
